...
Coef_De_Charge = {'Photovoltaique':0.17, 'CSP': 0.95, 'Dechets':0.90, 'Eolienne offshore': 0.5}
Prix_du_kw = {'Photovoltaique':1400, 'CSP': 9000, 'Dechets':15300, 'Eolienne offshore':8000}
Duree_De_Vie = {'Photovoltaique':25, 'CSP': 30, 'Dechets':25, 'Eolienne offshore':17}
...
prix_kwh_fuel = 0.28
prix_du_kwh = {'Photovoltaique':10, 'CSP': 12, 'Dechets':12, 'Eolienne offshore':11}
Capacite = {'Photovoltaique':10, 'CSP': 12, 'Dechets':12, 'Eolienne offshore':11}
taux_croiss_eco = 0.05
# inv = prix_du_kw*puissance(puissance est variable)